...
from src_helpers.file_helper import imagelist_in_depth

from src_helpers.image_helper import gray_hist, mask_overlay, get_gradient_magnitude
...
for i, image_file in enumerate(image_file_list):
    ...
    ax[1].imshow(filters.frangi(im_orig,scale_range=(1, 5),scale_step=1)>0.0000001, cmap=plt.cm.gray)
...
#    ax[2].set_title('Hybrid Hessian filter result')
    ...
    # felzenszwalb
    im_mask = segmentation.felzenszwalb(im_orig, scale=50, sigma=2,min_size=10)

...
from src_train.model_functions import create_shallow_model
...
# Evaluation action
#
def evaluate_test(input_map,reader_test,trainer,plot_data,epoch_size = 1100, minibatch_size=64,visualize=False):
...
reader_train = create_reader(train_map_image, data_mean_file, True, image_height=image_height, image_width=image_width, num_channels=num_channels, num_classes=num_classes)
reader_test  = create_reader(test_map_image, data_mean_file, False,  image_height=image_height, image_width=image_width, num_channels=num_channels, num_classes=num_classes)
